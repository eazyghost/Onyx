...
public class OldRotation {
    ...
    public static Vec3d getClientLookVec() {
        ClientPlayerEntity player = OnyxClient.me();
    ...
    public static Rotation getRequiredRotation(Vec3d vec, float tickDelta) {
        Vec3d offset = getEyePos().subtract(OnyxClient.me().getPos());
        Vec3d eyesPos = OnyxClient.me().getLerpedPos(tickDelta).add(offset);
