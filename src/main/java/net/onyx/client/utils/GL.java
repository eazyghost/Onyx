...
import net.onyx.client.interfaces.mixin.ICapabilityTracker;
import net.onyx.client.misc.PreInit;
import net.onyx.client.mixin.render.BufferRendererAccessor;
...
public class GL {
    ...
    public static void bindTexture(Identifier id) {
        ...
        OnyxClient.getClient().getTextureManager().bindTexture(id);
    }
