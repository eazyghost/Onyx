...
public class PlayerUtils {
    ...
    public static boolean canUpdate() {
        return OnyxClient.getClient() != null && OnyxClient.getClient().world != null && OnyxClient.getClient().player != null;
    }
    ...
    public static Dimension getDimension() {
        if (OnyxClient.getClient().world == null) return Dimension.Overworld;

        return switch (OnyxClient.getClient().world.getRegistryKey().getValue().getPath()) {
    ...
    public static double squaredDistanceToCamera(double x, double y, double z) {
        return OnyxClient.getClient().gameRenderer.getCamera().getPos().squaredDistanceTo(x, y, z);
    }
