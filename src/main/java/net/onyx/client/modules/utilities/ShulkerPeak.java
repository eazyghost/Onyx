...
public class ShulkerPeak extends Module {
    ...
    private void renderBackground(MatrixStack matrices, ItemStack stack, int x, int y) {
        ...
        TextRenderer r = OnyxClient.getClient().textRenderer;
    ...
    private void renderShulkerDisplay(MatrixStack mStack, ItemStack stack, int x, int y) {
        ...
        ItemRenderer ir = OnyxClient.getClient().getItemRenderer();
        TextRenderer r = OnyxClient.getClient().textRenderer;
    ...
    public void fireEvent(Event event) {
        switch (event.getClass().getSimpleName()) {
            ...
            case "InGameHudRenderEvent": {
                ...
                // Get the active item.
                ItemStack stack = OnyxClient.me().getMainHandStack();
                ...
                int x = OnyxClient.getClient().getWindow().getScaledWidth()/2 - BACKGROUND_WIDTH/2;
                int y = (int)(32/ OnyxClient.getClient().getWindow().getScaleFactor());
