...
public class XRay extends Module {
    ...
    public void activate() {
        ...
        this.fullbrightWasEnabled = OnyxClient.getInstance().getModules().get("fullbright").isEnabled();

        if (this.shouldOverrideFullbright()) OnyxClient.getInstance().getModules().get("fullbright").enable();
    ...
    public void deactivate() {
        ...
        if (this.shouldOverrideFullbright()) OnyxClient.getInstance().getModules().get("fullbright").disable();
