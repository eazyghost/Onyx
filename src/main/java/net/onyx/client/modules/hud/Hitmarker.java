...
import net.onyx.client.events.packet.OnGameStateChangeEvent;
import net.onyx.client.events.render.InGameHudRenderEvent;
import net.onyx.client.modules.Module;

public class Hitmarker extends Module {
    public static final Identifier HITMARKER_TEXTURE = new Identifier("walksy-client", "textures/gui/misc/hitmarker.png");
    public static final Identifier HITMARKER_SOUND = new Identifier("walksy-client:hitmarker");
    ...
    public void render(MatrixStack matrixStack, float partialTicks) {
        ...
        int x = OnyxClient.getClient().getWindow().getScaledWidth() / 2 - width / 2 + offsetX;
        int y = OnyxClient.getClient().getWindow().getScaledHeight() / 2 - height / 2 + offsetY;
    ...
    public void doHitmarker() {
        ...
        if (this.getBoolSetting("Sound")) OnyxClient.me().playSound(HITMARKER_SOUND_EVENT, 1, 1);
    }
    ...
    private void registerHit(LivingEntity entity) {
        ...
        this.hitTime = OnyxClient.getCurrentTime();
    }
    ...
    public void fireEvent(Event event) {
        switch (event.getClass().getSimpleName()) {
            ...
            case "ClientTickEvent": {
                ...
                if (OnyxClient.getCurrentTime() > this.hitTime + this.getDoubleSetting("MaxDelay")) {
                    this.resetHit();
            ...
            case "OnAttackEntityEvent": {
                ...
                if (e.player != OnyxClient.me() || !(e.target instanceof LivingEntity)) break;
